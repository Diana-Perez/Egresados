...
def consultas1():
    ...
    return render_template("consultas.html", unidad=unidad, areainv=areainv, departamento=departamento,sector=sector,añoinicial=añoinicial,añofinal=añofinal)    
...
def consultas():
    ...
    #Generando el dato json de columnas y preparando el row
